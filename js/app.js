...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <div class="mt-4">
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success"><i class="fas fa-plus"></i> Add To Cart</button>
      <button id="details-btn" class="btn btn-info text-white"><i class="fas fa-file"></i> Details</button></div>
      <div class="mt-4">
      <p><i class="fas fa-star"> ${product.rating.rate} ratings</i> / <i class="fas fa-user"> ${product.rating.count} reviews</i></p>
      </div>
      </div>
      `;
